            ...
            <?php if ($sec->section == "NEWS_ALL"): ?>
                <div class="container-fluid py-5">
                    <div class="container">
                        ...
                        <?= $sec->content; ?>
                        <?php if ($sec->has_carousel == 2) { ?>
                            <?php $news = $this->Menu_model->fetch_data_pages_by_limit_order('table_pages', ['id_domain' => $this->domain->id, 'category' => '2'])->result();
                            foreach ($news as $row) : ?>
                                <div class="col-xl-4 col-lg-6">
                                    <div class="bg-light rounded overflow-hidden">
                                        <img class="img-fluid w-100" src="<?= base_url('assets/uploads/img/') . $row->image; ?>" alt="">
                                        <div class="p-4">
                                            <a class="h3 d-block mb-3" href="<?= base_url() . $row->slug ?>"><?= $row->title ?></a>
